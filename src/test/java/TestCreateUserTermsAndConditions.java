...
public class TestCreateUserTermsAndConditions {

    @Test
    public void testCreateUserTermsAndConditions() throws InterruptedException{
        ...
        System.out.println("termsAndConditionsElement.getText() " + termsAndConditionsElement.getText());
