...
public class TestCreateUserWrongPassword {
    ...
    public void testCreateUserWithoutLastname() throws InterruptedException{
        ...
        driver.findElement(By.cssSelector("[id='signupunlicenced_confirmpassword']")).sendKeys("A12!12KKmm33");
        ...
        System.out.println("passwordElement.getText() " + passwordElement.getText());
